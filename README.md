...
![](https://res.cloudinary.com/ddb0y4vlh/image/upload/v1745883747/Sports-Gurus-schema_tgeiyg.png)

<!-- ![db-schema]

[db-schema]: ./images/Sports-Gurus-schema.png -->

Render.com database: (UPDATE:)
